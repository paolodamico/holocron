...
This is a reference implementation of a sealed box with a hybrid key encapsulation mechanism (post-quantum and classic elliptic curve). This is inspired by libsodium's [Sealed Boxes](https://libsodium.gitbook.io/doc/public-key_cryptography/sealed_boxes) where a message can be anonymously sent to a recipient given their public key.
